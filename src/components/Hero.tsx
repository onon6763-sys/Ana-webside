        ...
        <div className="lg:col-span-7 relative w-full h-[520px] sm:h-[620px] lg:h-[650px]">
          ...
          <div className="absolute -bottom-4 left-0 sm:left-4 w-[200px] sm:w-[260px] h-[260px] sm:h-[320px] border-[12px] border-white shadow-2xl bg-[#E5E7EB] overflow-hidden z-20 hidden sm:block">
            ...
            <img
              src="/images/ana7.jpg"
              alt="Ana - Moments"
              className="w-full h-full object-cover object-top filter contrast-[1.02] hover:scale-105 transition-all duration-500"
              onError={(e) => {
                e.currentTarget.src = "https://images.unsplash.com/photo-1517841905240-472988babdf9?auto=format&fit=crop&q=80&w=800";
              }}
            />
